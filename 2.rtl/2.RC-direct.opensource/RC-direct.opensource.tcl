...
set missing {}
foreach f [list $top_sv $soc_sv $cpu_v $xdc_file $hex_file] {
...
add_files -norecurse [concat $svfiles $vfiles [list $cpu_v $soc_sv $top_sv]]
...
foreach f [concat $svfiles [list $soc_sv $top_sv]] {
