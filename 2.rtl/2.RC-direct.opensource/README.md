...
Together with our [openPCIE backplane](../../1.pcb) and Simon's unique [end-to-end PCIE sim](../../5.sim) setup, this is **`one of the three core project deliverables`**
...
With both [RC-switched](../3.Bonus--RC-switched.opensource) and this direct use-case thus tried and proven to be true, we will have established a nicely rounded set of opensource examples and cores -- A solid foundation for the makers to build their future applications upon...
