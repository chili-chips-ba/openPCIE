...
set_property PACKAGE_PIN A6  [get_ports TXN]
set_property PACKAGE_PIN B6  [get_ports TXP]
set_property PACKAGE_PIN A10 [get_ports RXN]
set_property PACKAGE_PIN B10 [get_ports RXP]
